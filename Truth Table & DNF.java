...
public class Chall1_2 {
    ...
    public static void main(String[] args){
        System.out.println("This code draw Truth Table and give DNF of an expression.");
        System.out.println("For example: (¬a ∧ b ∧ ¬c ∧ d) ∨ (¬a ∧ b ∧ c ∧ d) ∨ (a ∧ b ∧ c ∧ d)");
        String input="(¬a ∧ b ∧ ¬c ∧ d) ∨ (¬a ∧ b ∧ c ∧ d) ∨ (a ∧ b ∧ c ∧ d)";
        print(input);
        System.out.println("Please input an expreesion consist only of {a,b,c,d,(,),¬,∧,∨,⊕,→,↔}:");
